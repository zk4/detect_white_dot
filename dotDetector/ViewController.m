...
- (NSMutableArray*) dectectWhitestDot:(const unsigned char*) array width:(int) width height:(int)height isWhiteThreadhold:(float) whiteThreash  boundingX:(int)bx boundingY:(int)by{
    float maxavg = 0.f;
...
- (NSMutableArray *) dectectWhiteDots:(const unsigned char*) array width:(int) width height:(int)height isWhiteThreadhold:(float) whiteThreash  boundingX:(int)bx boundingY:(int)by{
    float maxavg = 0.f;
    NSMutableArray * nsa =  [[NSMutableArray alloc]init];
    CGRect ret = CGRectMake(-1,-1,0,0);
     for(int y = 0; y< height-by+1; y++){
...
//    image = [self convertImageToGrayScale:image];
    ...
    NSMutableArray * rects = [self dectectWhitestDot:bytes width:image.size.width height:image.size.height isWhiteThreadhold:.7f  boundingX:10  boundingY:10];
